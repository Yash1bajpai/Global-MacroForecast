...
print("\nNOTE: US GDP series (GDPC1) is a level, converted to QoQ log-% growth")
print("during preprocessing (log_diff_pct).")
...
plt.close()
print("\nACF/PACF plot saved: notebooks/us_acf_pacf.png")
...
print("\nFitting SARIMA(1,0,1)(0,0,0,4) on US...")
